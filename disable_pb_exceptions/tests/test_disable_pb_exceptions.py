...
@patch('disable_pb_exceptions.index.update_account_pb_exception_gql')
@patch('disable_pb_exceptions.index.update_account_pb')
@patch('disable_pb_exceptions.index.get_account_by_project_id_gql')
@patch('disable_pb_exceptions.index.authorize_lambda_request')
def test_001_handler_success(mock_auth, mock_get_account, mock_update_pb, mock_update_pb_exc):
    ...
    from disable_pb_exceptions.index import handler
    # Call method
...
@patch('disable_pb_exceptions.index.get_account_by_project_id_gql')
@patch('disable_pb_exceptions.index.authorize_lambda_request')
def test_002_handler_success_already_disabled(mock_auth, mock_get_account, mock_update_pb, mock_update_pb_exc):
    mock_auth.return_value = True
    mock_get_account.return_value = {
        "pb_exceptions": None,
        "id": "random",
...
@patch('disable_pb_exceptions.index.get_account_by_project_id_gql')
@patch('disable_pb_exceptions.index.authorize_lambda_request')
def test_003_handler_fail_invalid_account(mock_auth, mock_get_account):
    mock_auth.return_value = True
    mock_get_account.return_value = {}
    from disable_pb_exceptions.index import handler
    # Call method
...
@patch('disable_pb_exceptions.index.authorize_lambda_request')
def test_004_handler_fail_invalid_payload_exception_actions(mock_auth):
    mock_auth.return_value = True
    from disable_pb_exceptions.index import handler
    # Call method
...
@patch('disable_pb_exceptions.index.authorize_lambda_request')
def test_005_handler_fail_invalid_payload_project_id(mock_auth):
    mock_auth.return_value = True
    from disable_pb_exceptions.index import handler
    # Call method
...
@patch('disable_pb_exceptions.index.authorize_lambda_request')
def test_006_handler_fail_invalid_auth(mock_auth):
...
@patch('disable_pb_exceptions.index.get_account_by_project_id_gql')
@patch('disable_pb_exceptions.index.authorize_lambda_request')
def test_007_handler_fail_exception(mock_auth, mock_get_account, mock_update_pb_exc):
    mock_auth.return_value = True
    mock_get_account.return_value = {
        "pb_exceptions": None,
        "id": "random",
    ...
    mock_update_pb_exc.side_effect = Exception("error")
    from disable_pb_exceptions.index import handler
    # Call method
    result = handler(MockLambdaEvent("itx-000", ["mock:Mock"]).get_event(), None)
